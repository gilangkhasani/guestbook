...
// public members:
   ...
   */
   ...
   Parameters:
      $host      : SMPP ip to connect to.   10.3.224.111
      $port      : port # to connect to.    2775 or 2776
      $username   : SMPP system ID          test
      $password   : SMPP passord.           test
      $system_type   : SMPP System type     TCP
   Example:
   ...
   */
   function Start($host, $port, $username, $password, $system_type)
   {
      ...
      } else echo "Connected to SMPP server..........................................\n";
   }
   ...
   */
   function Send($to, $text)
   {
      ...
      else echo "\tMessage sent successfuly to $to";
   }
